...
'
' The Guid attribute sets the CLSID for ASCOM.ASCOM.GuidePortBuddy.Telescope.Rate
' The ClassInterface/None attribute prevents an empty interface called
' _Rate from being created and used as the [default] interface
'
<Guid("da6d3440-fbaa-45ab-9735-75ca7893adc3")>
...
' this polymorphism. 
'
' The Guid attribute sets the CLSID for ASCOM.ASCOM.GuidePortBuddy.Telescope.AxisRates
' The ClassInterface/None attribute prevents an empty interface called
' _AxisRates from being created and used as the [default] interface
'
<Guid("f639d9cc-e8db-4f55-a6e3-d674b9221e1e")>
<ClassInterface(ClassInterfaceType.None)>
<ComVisible(True)>
...
' this polymorphism. 
'
' The Guid attribute sets the CLSID for ASCOM.ASCOM.GuidePortBuddy.Telescope.TrackingRates
' The ClassInterface/None attribute prevents an empty interface called
' _TrackingRates from being created and used as the [default] interface
'
<Guid("f20a88f5-1aa2-45e9-a979-4dd8cfb88a96")>
<ClassInterface(ClassInterfaceType.None)>
<ComVisible(True)>
